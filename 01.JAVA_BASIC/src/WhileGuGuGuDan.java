...
public class WhileGuGuGuDan {
	...
	public static void main(String[] args) {
		...
		/********************
		 * 출력형식************************** 2*1=2 3*1=3 4*1=4 5*1=5 6*1=6 7*1=7 8*1=8
		 * 9*1=9 2*2=4 3*2=6 4*2=8 5*2=10 6*2=12 7*2=14 8*2=16 9*2=18 2*3=6 3*3=9 4*3=12
		...
		while (i <= 9) {
			...
			while (j <= 9) {
				int c = j * i;
				System.out.printf("%d*%d=%2d ", j, i, c);
				j++;
			}
			System.out.print("\n");
			i++;
