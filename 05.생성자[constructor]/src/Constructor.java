...
public class Constructor {
	...
	/*
	 * 생성자 메소드:객체생성 후 최초로 단 한번 호출되는 메소드(???)
	 */

	public Constructor() {
		System.out.println("public Constructor() 기본 생성자 호출" + this);

	}
	/*
	 * 생성자 메소드 안에서는 생성된 객체의 self참조변수 this를 사용할 수 있다
	 * 
	 */
	...
	public Constructor(int member1) {
		System.out.println("public Constructor(int member1) 생성자 호출" + this.member1);

	}
	//1개 짜리는 해당 인수만 들어가야 사용할 수 있다.
