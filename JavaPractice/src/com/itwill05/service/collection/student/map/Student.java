...
public class Student {
	...
	*/
	...
	public Student(int no, String ban, String name, int kor, int eng, int math) {
		super();
		this.no = no;
		this.ban = ban;
		this.name = name;
	...
	*/
	...
	public static void headerPrint() {
		...
		System.out.printf("%s %s %s %s %s %s %s %3s %s %s %s%n","반","학번", "이름", "국어", "영어", "수학", "총점", "평균", "평점", "반석차","전체석차");
		System.out.printf("----------------------------------------------------------%n");

	}

	public void print() {
		System.out.printf("%2s %3d %5s %4d %4d %4d %4d %5.1f %3c %6d %7d%n", this.ban,this.no, this.name, this.kor, this.eng, this.math,
				this.tot, this.avg, this.grade, this.banRank,this.rank);
	}
	/*
	 * 석차증가
	 */
